...
public class TestExistingAlgorithmRun {
	...
	public void testAdditionalRunWeirdCharacters()
	{
		...
		RunConfig rc = new RunConfig(new ProblemInstanceSeedPair(new ProblemInstance("test"),2), 25.0, ParamConfigurationSpace.getSingletonConfigurationSpace().getDefaultConfiguration() );
