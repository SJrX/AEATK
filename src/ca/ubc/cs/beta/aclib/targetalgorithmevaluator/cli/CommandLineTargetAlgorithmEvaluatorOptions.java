...
public class CommandLineTargetAlgorithmEvaluatorOptions extends AbstractOptions {
	...
	@Parameter(names="--cli-observer-frequency", description="How often to notify observer of updates (in seconds)", validateWith=FixedPositiveInteger.class)
	public int observerFrequency = 10;
